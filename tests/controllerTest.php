<?php
require_once(ROOT.'/vendor/phphoenix/core/classes/PHPhoenix/Controller.php');
...
class ControllerTest extends PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new TestController($this->phoenix);
	}
	...
	public function testException()
	{
		...
		} catch (\PHPhoenix\Exception\PageNotFound $e) {
			$except = true;
		}
