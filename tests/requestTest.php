...
namespace {
	...
	class requestTest extends PHPUnit_Framework_TestCase
	{
		...
		protected function setUp()
		{
			...
			$this->phoenix->app_namespace = "";
			$this->object = new \PHPhoenix\Request(
				$this->phoenix,
				new \PHPhoenix\Route('/','test',array(),array()),
				'GET', 
				...
				array('fairy_server' => 'Trixie', 'HTTP_HOST' => 'phphoenix.com', 'REQUEST_URI' => '/test/?test=test'),
		...
		{
			$this->object->execute();
			$this->assertEquals('Trixie', $this->phoenix->cookie->get('fairy_cookie'));
		}
		...
		{
			$this->assertEquals('http://phphoenix.com/test/', $this->object->url());
			$this->assertEquals('http://phphoenix.com/test/?test=test', $this->object->url(true));
			$this->object = new \PHPhoenix\Request($this->phoenix, $this->object->route, 'GET', array(), array(), array(),
				array('HTTPS' => 'on','HTTP_HOST'=>'phphoenix.com','REQUEST_URI'=>'/test/?test=test')
			);
			$this->assertEquals('https://phphoenix.com/test/', $this->object->url());
			$this->assertEquals('https://phphoenix.com/test/?test=test', $this->object->url(true));
